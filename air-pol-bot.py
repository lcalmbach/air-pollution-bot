...
params = {}
params['pm2_5_stundenmittelwerte_ug_m3'] = {'guideline':25, 'text': "⚠️ Hohe Feinstaub 2.5μm Konzentration in Basel: {} μg/m3. 2.5*Grenzw. jährliches Mittel=25μg/m3. Daten von @OpenDataBS: {}",'last_tweet':(datetime.now() - timedelta(1))}
params['pm10_stundenmittelwerte_ug_m3'] = {'guideline':50, 'text': "⚠️ Hohe Feinstaub 10μm Konzentration in Basel: {} μg/m3. Grenzw. = 50μg/m3. Daten von @OpenDataBS: {}",'last_tweet':(datetime.now() - timedelta(1))}
params['o3_stundenmittelwerte_ug_m3'] = {'guideline':120, 'text': "⚠️ Hohe Ozon Konzentration in Basel: {} μg/m3. Grenzw. 120μg/m3. Daten von @OpenDataBS: {}",'last_tweet':(datetime.now() - timedelta(1))}
