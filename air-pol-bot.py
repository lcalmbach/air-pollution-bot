...
params = {}
params['pm2_5_stundenmittelwerte_ug_m3'] = {'guideline':25, 'text': "⚠️ Hohe Feinstaub 2.5μm Konzentration in Basel: {} μg/m3. Grenzw. jährliches Mittel=10μg/m3. Alle Daten unter @OpenDataBS: {}",'last_tweet':(datetime.now() - timedelta(1))}
params['pm10_stundenmittelwerte_ug_m3'] = {'guideline':50, 'text': "⚠️ Hohe Feinstaub 10μm Konzentration in Basel: {} μg/m3. Grenzw. jährliches Mittel=25μg/m3. Alle Daten unter @OpenDataBS: {}",'last_tweet':(datetime.now() - timedelta(1))}
